# Computer Procurement at FUW

We need four items to launch a procurement call:

+ 3 offers, for which we can contact any Polish company to obtain a quote. It is acceptable to have vendor specifications in those three offers (such as MacBook Pro 14" with 1TB hard drive) and even model numbers. Any offer must contain the following three parts:
  +  the price
